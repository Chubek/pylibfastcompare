...
def assemble_file(
    ...
    for nt, hm in hm_names.items():
        ...
        for name, ty, mx in zip(
            ...
            final_prosumers += f"extern {ty} {name}[{mx}] = {{0}};\n"
...
def save_file(ptxts: List[Dict[str, str]], all_headers: str, all_headers_path: str):
...
if __name__ == "__main__":
    ...
    argp.add_argument("-ha", "--header_all", default="generated-include/generated-workers.h")
    ...
    txt_fin, header_fin = assemble_file(
        args.static_txt,
        args.signature,
        args.header_out,
        args.header_inc_tmp,
    ...
    save_file(txt_fin, header_fin, args.header_all)
